...
const dmi_entity_spec_t dmi_intel_rsd_storage_device_spec =
{
    ...
    .fields = DMI_FIELDS({
        DMI_FIELD_STRING(dmi_intel_rsd_storage_device_t, port),
        DMI_FIELD(dmi_intel_rsd_storage_device_t, index,     dmi_byte_t),
        DMI_FIELD(dmi_intel_rsd_storage_device_t, connector, dmi_byte_t),
        DMI_FIELD(dmi_intel_rsd_storage_device_t, protocol,  dmi_byte_t),
        DMI_FIELD(dmi_intel_rsd_storage_device_t, type,      dmi_byte_t),
        DMI_FIELD(dmi_intel_rsd_storage_device_t, capacity,  dmi_dword_t),
        DMI_FIELD(dmi_intel_rsd_storage_device_t, rpm,       dmi_word_t),
        DMI_FIELD_STRING(dmi_intel_rsd_storage_device_t, model),
        DMI_FIELD_STRING(dmi_intel_rsd_storage_device_t, serial_number),
        DMI_FIELD(dmi_intel_rsd_storage_device_t, pci_class,     dmi_byte_t),
        DMI_FIELD(dmi_intel_rsd_storage_device_t, vendor_id,     dmi_word_t),
        DMI_FIELD(dmi_intel_rsd_storage_device_t, device_id,     dmi_word_t),
        DMI_FIELD(dmi_intel_rsd_storage_device_t, sub_vendor_id, dmi_word_t),
        DMI_FIELD(dmi_intel_rsd_storage_device_t, sub_device_id, dmi_word_t),
        DMI_FIELD_STRING(dmi_intel_rsd_storage_device_t, firmware_version),
        {}
    }),
