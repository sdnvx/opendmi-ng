...
static void dmi_current_probe_lint_range(dmi_lint_t *lint, const dmi_entity_t *entity);

static const dmi_lint_rule_t dmi_current_probe_range_rule =
{
    .code              = "current-probe.range",
    .name              = "Nominal value of the probe is within its limits",
    .severity          = DMI_LINT_SEVERITY_WARNING,
    .producer_severity = DMI_LINT_SEVERITY_ERROR,
    .scope             = DMI_LINT_SCOPE_ENTITY,
    .check             = dmi_current_probe_lint_range
};
