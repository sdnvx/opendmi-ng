...
static void dmi_temperature_probe_lint_range(dmi_lint_t *lint, const dmi_entity_t *entity);

static const dmi_lint_rule_t dmi_temperature_probe_range_rule =
{
    .code              = "temperature-probe.range",
    .name              = "Nominal value of the probe is within its limits",
    .severity          = DMI_LINT_SEVERITY_WARNING,
    .producer_severity = DMI_LINT_SEVERITY_ERROR,
    .scope             = DMI_LINT_SCOPE_ENTITY,
    .check             = dmi_temperature_probe_lint_range
};
...
const dmi_entity_spec_t dmi_temperature_probe_spec =
{
    ...
    .lint_rules      = (const dmi_lint_rule_t *const[]){
        &dmi_temperature_probe_range_rule,
        nullptr
    },
