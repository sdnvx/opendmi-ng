...
const dmi_name_set_t dmi_processor_type_names =
{
    .code  = "processor-type",
    .names = DMI_NAMES({
...
const dmi_name_set_t dmi_processor_family_names =
{
...
const dmi_name_set_t dmi_processor_status_names =
{
...
const dmi_name_set_t dmi_processor_voltage_names =
{
...
const dmi_name_set_t dmi_processor_upgrade_names =
{
