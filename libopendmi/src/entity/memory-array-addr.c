...
const dmi_entity_spec_t dmi_memory_array_addr_spec =
{
    ...
    .fields = DMI_FIELDS({
        ...
        DMI_FIELD(dmi_memory_array_addr_t, start_addr, DWORD, .convert = dmi_field_kilobytes),
        DMI_FIELD(dmi_memory_array_addr_t, end_addr,   DWORD, .convert = dmi_field_kilobytes),
