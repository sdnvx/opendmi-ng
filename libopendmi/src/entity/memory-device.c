...
const dmi_entity_spec_t dmi_memory_device_spec =
{
    ...
    .fields = DMI_FIELDS({
        DMI_FIELD(dmi_memory_device_t, array_handle,      dmi_word_t),
        DMI_FIELD(dmi_memory_device_t, error_info_handle, dmi_word_t),
        DMI_FIELD(dmi_memory_device_t, total_width,       dmi_word_t, .unknown_raw = 0xFFFF),
        DMI_FIELD(dmi_memory_device_t, data_width,        dmi_word_t, .unknown_raw = 0xFFFF),
        DMI_FIELD(dmi_memory_device_t, size,              dmi_word_t,
                  .unknown_raw = 0xFFFF,
                  .decode      = dmi_memory_device_decode_size,
                  .encode      = dmi_memory_device_encode_size),
        DMI_FIELD(dmi_memory_device_t, form_factor,       dmi_byte_t),
        ...
        DMI_FIELD_GROUP(),
        DMI_FIELD_STRING(dmi_memory_device_t, vendor),
        DMI_FIELD_STRING(dmi_memory_device_t, serial_number),
        ...
        DMI_FIELD_EXTENDED(dmi_memory_device_t, size, dmi_dword_t,
                           .when_raw = 0x7FFF,
                           .decode   = dmi_memory_device_decode_size_ex,
                           .encode   = dmi_memory_device_encode_size_ex),

        DMI_FIELD_GROUP(),
        DMI_FIELD(dmi_memory_device_t, configured_speed, dmi_word_t),

        DMI_FIELD_GROUP(.since = DMI_VERSION(2, 8, 0)),
        DMI_FIELD(dmi_memory_device_t, minimum_voltage,    dmi_word_t),
        DMI_FIELD(dmi_memory_device_t, maximum_voltage,    dmi_word_t),
        ...
        DMI_FIELD(dmi_memory_device_t, controller_vendor_id,  dmi_word_t),
        DMI_FIELD(dmi_memory_device_t, controller_product_id, dmi_word_t),
        DMI_FIELD(dmi_memory_device_t, non_volatile_size,     dmi_qword_t),
        DMI_FIELD(dmi_memory_device_t, volatile_size,         dmi_qword_t),
        DMI_FIELD(dmi_memory_device_t, cache_size,            dmi_qword_t),
        DMI_FIELD(dmi_memory_device_t, logical_size,          dmi_qword_t),

        DMI_FIELD_GROUP(.since = DMI_VERSION(3, 3, 0)),
        DMI_FIELD_EXTENDED(dmi_memory_device_t, maximum_speed,    dmi_dword_t, .when_raw = 0xFFFF),
        DMI_FIELD_EXTENDED(dmi_memory_device_t, configured_speed, dmi_dword_t, .when_raw = 0xFFFF),

        DMI_FIELD_GROUP(.since = DMI_VERSION(3, 7, 0)),
        DMI_FIELD(dmi_memory_device_t, pmic0_vendor_id, dmi_word_t),
        DMI_FIELD(dmi_memory_device_t, pmic0_revision,  dmi_word_t),
        DMI_FIELD(dmi_memory_device_t, rcd_vendor_id,   dmi_word_t),
        DMI_FIELD(dmi_memory_device_t, rcd_revision,    dmi_word_t),
        {}
    }),
