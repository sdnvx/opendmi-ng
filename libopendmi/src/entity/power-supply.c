...
const dmi_entity_spec_t dmi_power_supply_spec =
{
    ...
    .fields = DMI_FIELDS({
        DMI_FIELD(dmi_power_supply_t, group,            BYTE),
        DMI_FIELD(dmi_power_supply_t, location,         STRING),
        DMI_FIELD(dmi_power_supply_t, name,             STRING),
        DMI_FIELD(dmi_power_supply_t, vendor,           STRING),
        DMI_FIELD(dmi_power_supply_t, serial_number,    STRING),
        DMI_FIELD(dmi_power_supply_t, asset_tag,        STRING),
        DMI_FIELD(dmi_power_supply_t, part_number,      STRING),
        DMI_FIELD(dmi_power_supply_t, revision,         STRING),
        DMI_FIELD(dmi_power_supply_t, maximum_capacity, WORD),
        ...
        DMI_FIELD_GROUP(),
        DMI_FIELD(dmi_power_supply_t, voltage_probe_handle,  WORD,
                  .absent = dmi_value_ptr(DMI_HANDLE_INVALID)),
        DMI_FIELD(dmi_power_supply_t, cooling_device_handle, WORD,
                  .absent = dmi_value_ptr(DMI_HANDLE_INVALID)),
        DMI_FIELD(dmi_power_supply_t, current_probe_handle,  WORD,
                  .absent = dmi_value_ptr(DMI_HANDLE_INVALID)),
        {}
    }),
